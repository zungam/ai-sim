...
How to make RNG sequence "persistent"?
Store xor128 state inside sim_State perhaps
But then, how to seed?
Seed -> Use different initial values for xor128
Seed should not affect the parameters however.
...
//     the IARC rules.
// Remarks
//     The internally generated seed is generated by calling time(.),
//     the precision of which is about one second. Keep this in mind if you
//     intend to call this function many times'a second. I would suggest to
//     generate a sequence of random numbers beforehand, and use them as seeds.
// Return
